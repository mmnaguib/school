...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'ar_notes'              => 'الملاحظات باللغة العربية',
        'en_notes'              => 'الملاحظات باللغة الانجليزية',
        'listclasses.*.ar_name' => 'الاسم باللغة العربية',
        'listclasses.*.en_name' => 'الاسم باللغة الانجليزية',
        'Grade_id'              => 'اسم المرحلة',
        'ar_babajob'=> 'اسم الوظيفة باللغة العربية',
        'en_babajob'=> 'اسم الوظيفة باللغة الانجليزية',
        'ar_mamajob'=> 'اسم الوظيفة باللغة العربية',
        'en_mamajob'=> 'اسم الوظيفة باللغة الانجليزية',
        'ar_babaname'=>'اسم الاب باللغة العربية',
        'en_babaname'=>'اسم الاب باللغة الانجليزية',
        'ar_mamaname'=>'اسم الام باللغة العربية',
        'en_mamaname'=>'اسم الام باللغة الانجليزية',
        'baba_id'=>'البطاقة',
        'baba_passport'=>'جواز السفر',
        'baba_phone'=>'الهاتف',
        'mama_id'=>'البطاقة',
        'mama_passport'=>'جواز السفر',
        'mama_phone'=>'الهاتف',
        'baba_address'=>'عنوان الاب',
        'mama_address'=>'عنوان الام',

        'baba_nationality'=>'الجنسية',
        'baba_bloodType'=>'فصيلة الدم',
        'baba_religions'=>'الديانة',
        'mama_nationality'=>'الجنسية',
        'mama_bloodType'=>'فصيلة الدم',
        'mama_religions'=>'الديانة',
    ],
