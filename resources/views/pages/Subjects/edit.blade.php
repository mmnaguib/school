                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>@lang('site.' . $locale . '.subject')</label>
                                            <input type="text" class="form-control" name="{{ $locale }}_subject" id="{{ $locale }}_subject" value="{{ $subject->setLocale($locale)->name }}" />
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <select class="custom-select my-1 mr-sm-2" name="Grade_id">
                                            <option selected disabled>@lang('site.choose_grade')</option>
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <select name="Class_id" class="custom-select">
                                            <option
                                                value="{{ $subject->classroom->id }}">{{ $subject->classroom->classroom_name }}
                                            </option>
                                        </select>
                                    </div>
