...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> @lang('site.payment') {{ $payment->student->name }}</h4>
        </div>
        <div class="col-sm-6">
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('payment_students.update', $payment->id) }}"> @csrf @method('PUT')
                    <div class="row">
                        <div class="col-md-12">
                            <label>@lang('site.amount') <span class="text-danger">*</span></label>
                            <input type="text" name="debit" class="form-control" value="{{ $payment->amount }}"/>
